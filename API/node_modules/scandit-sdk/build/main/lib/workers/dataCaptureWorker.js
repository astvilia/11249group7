...
function dataCapture() {
    ...
    function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newHighEndBlurryRecognition, textRecognition, newLicenseKey, deviceModelName) {
        ...
        Module = {
            ...
            instantiateWasm: function (importObject, successCallback) {
                ...
                if (wasmJSVersion !== "5.9.0") {
                    log("error", "The Scandit Data Capture library JS file found at " + jsURI + " seems invalid: " +
                        ("expected version doesn't match (received: " + wasmJSVersion + ", expected: " + "5.9.0" + "). ") +
            ...
            print: function () {
                ...
                log.apply(void 0, (0, tslib_1.__spreadArray)(["info"], (0, tslib_1.__read)(data), false));
            },
            // tslint:disable-next-line: no-any
            printErr: function () {
                var data = [];
                ...
                log.apply(void 0, (0, tslib_1.__spreadArray)(["error"], (0, tslib_1.__read)(data), false));
            },
        };
    ...
    function getLibraryLocationURIs(libraryLocation, textRecognition, simdSupport) {
        ...
        return {
            jsURI: libraryLocation + "scandit-engine-sdk" + fileExtension + ".min.js?v=5.9.0",
            wasmURI: libraryLocation + "scandit-engine-sdk" + fileExtension + ".wasm?v=5.9.0",
        };
    }
        ...
        function verifyResponseData(responseData) {
            ...
            if (typeof ((_a = crypto === null || crypto === void 0 ? void 0 : crypto.subtle) === null || _a === void 0 ? void 0 : _a.digest) === "function") {
                crypto.subtle
                    ...
                    var expectedHashString = "40e84fd0fce799334e8e70ee8adb1c7ecef93306071fd42bcb20034d54703211";
                    if (textRecognition) {
                ...
                cursorRequest_1.onsuccess = function () {
                    ...
                    if (cursor == null) {
                        try {
                            ...
                            try {
                                for (var objects_2 = (0, tslib_1.__values)(objects_1), objects_2_1 = objects_2.next(); !objects_2_1.done; objects_2_1 = objects_2.next()) {
