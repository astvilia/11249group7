    ...
    CameraManager.prototype.stopStream = function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                ...
                if (this.mediaStream != null) {
                    logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Stop camera video stream access (stream):", this.mediaStream);
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera reinitialization delayed");
                        return [3 /*break*/, 5];
                    case 1:
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Reinitialize camera:", this.activeCamera);
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                    ...
                    case 4:
                        error_1 = _a.sent();
                        logger_1.Logger.log(logger_1.Logger.Level.WARN, "Couldn't access camera:", this.activeCamera, error_1);
                        this.triggerCameraAccessError(error_1);
                        throw error_1;
            ...
            return (0, tslib_1.__generator)(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _d.label = 2;
                    case 2: return [4 /*yield*/, cameraAccess_1.CameraAccess.getCameras(false, true)];
                    case 3:
                        cameras = _d.sent();
                        ...
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Initial camera access was correct (main camera), keep camera:", activeCamera);
                    ...
                    case 4:
                        ...
                        return [2 /*return*/];
                    case 5:
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Initial camera access was incorrect (not main camera), change camera", (0, tslib_1.__assign)((0, tslib_1.__assign)({}, initialCamera_1), { deviceId: initialCameraDeviceId_1 }));
                        _d.label = 6;
                    case 6: return [3 /*break*/, 8];
                    case 7:
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Initial camera access was incorrect (unknown camera), change camera", (0, tslib_1.__assign)((0, tslib_1.__assign)({}, initialCamera_1), { deviceId: initialCameraDeviceId_1 }));
                        _d.label = 8;
                    case 8:
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (cameras.length >= 1) {
                            logger_1.Logger.log(logger_1.Logger.Level.WARN, "Couldn't access camera:", autoselectedCamera, error_2);
                            autoselectedCamera = cameras.shift();
                            return [3 /*break*/, 1];
                        }
                        throw error_2;
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, 'Detected video track "ended" event, try to reinitialize camera');
                        return [4 /*yield*/, this.reinitializeCamera()];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, 'Detected video track "unmute" event, try to reinitialize camera');
                        return [4 /*yield*/, this.reinitializeCamera()];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
    ...
    CameraManager.prototype.triggerManualFocusForContinuous = function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.manualToAutofocusResumeTimeout = window.setTimeout(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                            return (0, tslib_1.__generator)(this, function (_a) {
                                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.manualFocusWaitTimeout = window.setTimeout(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                            return (0, tslib_1.__generator)(this, function (_a) {
                                switch (_a.label) {
                ...
                switch (_a.label) {
                    case 0:
                        if (!["OverconstrainedError", "NotReadableError"].includes(error.name) ||
                            ...
                            logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access failure (unrecoverable error)", camera, error);
                        ...
                        if (camera.deviceId === "") {
                            logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access failure (no camera with such type error)", camera, error);
                            throw error;
                        }
                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Detected non-existent deviceId error, attempt to find and reaccess updated camera", camera, error);
                    ...
                    case 1:
                        ...
                        if (currentCameraDeviceId === camera.deviceId) {
                            logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access failure (updated camera not found after non-existent deviceId error)", camera, error);
                            cameraAccess_1.CameraAccess.markCameraAsInaccessible(camera);
                            throw error;
                        }
                        else {
                            logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Updated camera found (recovered from non-existent deviceId error), attempt to access it", camera);
                    ...
                    case 3:
                        ...
                        if (typeof stream.getTracks()[0].getSettings === "function") {
                            ...
                            if (mediaTrackSettings.width != null &&
                                ...
                                logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access failure (invalid video metadata):", camera);
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (_, reject) {
                        _this.cameraAccessTimeout = window.setTimeout(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                            return (0, tslib_1.__generator)(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access failure (video data load timeout):", camera);
                                        return [4 /*yield*/, this.stopStream()];
                                    case 1:
                                        _a.sent();
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.gui.videoElement.onloadeddata = function () {
                            ...
                            if (_this.gui.videoElement.videoWidth > 2 &&
                                ...
                                logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access success:", camera);
                                return resolve();
                            }
                            var videoMetadataCheckStartTime = performance.now();
                            window.clearInterval(_this.videoMetadataCheckInterval);
                            _this.videoMetadataCheckInterval = window.setInterval(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                return (0, tslib_1.__generator)(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            logger_1.Logger.log(logger_1.Logger.Level.DEBUG, "Camera video stream access failure (valid video metadata timeout):", camera);
                                            window.clearInterval(this.videoMetadataCheckInterval);
                                            return [4 /*yield*/, this.stopStream()];
                                        case 1:
                                            _a.sent();
