...
var BarcodePickerEventEmitter = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(BarcodePickerEventEmitter, _super);
...
var BarcodePicker = /** @class */ (function () {
    function BarcodePicker(originElement, _a) {
        ...
        if (singleImageModeEnabled) {
            this.cameraManager = new dummyCameraManager_1.DummyCameraManager(this.scanner, this.triggerCameraAccessError.bind(this), this.gui);
            this.gui.setCameraType(cameraType);
        }
        else {
            this.cameraManager = new cameraManager_1.CameraManager(this.scanner, this.triggerCameraAccessError.bind(this), this.gui);
    ...
    // @ts-ignore
    // istanbul ignore next
    BarcodePicker.cameraAccessError = function (error) {
        // Ignored
    };
    /**
                ...
                switch (_v.label) {
                    case 0:
                        ...
                        if (!browserCompatibility.fullSupport && !singleImageModeForced) {
                            logger_1.Logger.log(logger_1.Logger.Level.INFO, "BarcodePicker's Single Image Mode is being used as fallback as the OS/browser combination doesn't " +
    ...
    BarcodePicker.prototype.triggerCameraAccessError = function (error) {
    ...
    BarcodePicker.prototype.scheduleVideoProcessing = function (timeout) {
        ...
        window.setTimeout(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
