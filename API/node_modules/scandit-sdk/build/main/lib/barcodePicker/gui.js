...
var GUI = /** @class */ (function () {
    ...
    GUI.prototype.cameraUploadFile = function () {
        ...
        if (files != null && files.length !== 0) {
            ...
            fileReader_1.onerror = function () {
                var _a;
                _this.cameraUploadInProgress = false;
                logger_1.Logger.log(logger_1.Logger.Level.WARN, "Error while reading the file: " + ((_a = fileReader_1.error) === null || _a === void 0 ? void 0 : _a.toString()));
            };
    ...
    GUI.prototype.setupTorchToggler = function () {
        ...
        ["touchstart", "mousedown"].forEach(function (eventName) {
            _this.torchTogglerElement.addEventListener(eventName, function (event) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                return (0, tslib_1.__generator)(this, function (_a) {
                    switch (_a.label) {
                        case 0:
