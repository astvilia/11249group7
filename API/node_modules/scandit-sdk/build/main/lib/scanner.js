...
var ScannerEventEmitter = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(ScannerEventEmitter, _super);
...
var Scanner = /** @class */ (function () {
    ...
    Scanner.prototype.applyScanSettings = function (scanSettings) {
        ...
        if (this.blurryRecognitionAvailable) {
            this.activeBlurryRecognitionSymbologies = new Set((0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.activeBlurryRecognitionSymbologies), false), (0, tslib_1.__read)(activeBlurryRecognitionSymbologies), false));
        }
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this.eventEmitter.once(workResultEvent, function (workResult, returnedImageData) {
                            ...
                            resolve(new scanResult_1.ScanResult(workResult.barcodes, workResult.texts, returnedImageData, _this.imageSettings));
                        });
                        _this.eventEmitter.once(workErrorEvent, function (error, _) {
                            logger_1.Logger.log(logger_1.Logger.Level.ERROR, "Scandit Data Capture error (" + error.errorCode + "):", error.errorMessage);
    ...
    Scanner.prototype.handleBlurryTablesUpdate = function () {
        ...
        this.blurryRecognitionAvailable = index_1.blurryRecognitionPreloader.isBlurryRecognitionAvailable(this.scanSettings);
        if (this.blurryRecognitionAvailable) {
            this.activeBlurryRecognitionSymbologies = new Set((0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.activeBlurryRecognitionSymbologies), false), (0, tslib_1.__read)(index_1.blurryRecognitionPreloader.getEnabledSymbologies(this.scanSettings)), false));
            this.dataCaptureWorker.postMessage({
                type: "scan-settings",
                settings: this.scanSettings.toJSONString(),
    ...
    Scanner.prototype.dataCaptureWorkerOnMessage = function (ev) {
        var data = ev.data;
        if (data[0] === "log") {
            logger_1.Logger.log.apply(logger_1.Logger, (0, tslib_1.__spreadArray)([data[1].level], (0, tslib_1.__read)(data[1].data), false));
            return;
        }
