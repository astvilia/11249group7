...
var textRecognitionSettings_1 = require("./textRecognitionSettings");
/**
...
var ScanSettings = /** @class */ (function () {
    ...
    function ScanSettings(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.textRecognitionSettings, textRecognitionSettings = _c === void 0 ? new textRecognitionSettings_1.TextRecognitionSettings() : _c, _d = _b.recognitionMode, recognitionMode = _d === void 0 ? ScanSettings.RecognitionMode.CODE : _d, _e = _b.enabledSymbologies, enabledSymbologies = _e === void 0 ? [] : _e, _f = _b.codeDuplicateFilter, codeDuplicateFilter = _f === void 0 ? 0 : _f, _g = _b.maxNumberOfCodesPerFrame, maxNumberOfCodesPerFrame = _g === void 0 ? 1 : _g, _h = _b.searchArea, searchArea = _h === void 0 ? { x: 0, y: 0, width: 1.0, height: 1.0 } : _h, _j = _b.gpuAcceleration, gpuAcceleration = _j === void 0 ? true : _j, _k = _b.blurryRecognition, blurryRecognition = _k === void 0 ? true : _k, _l = _b.codeDirectionHint, codeDirectionHint = _l === void 0 ? ScanSettings.CodeDirection.LEFT_TO_RIGHT : _l, deviceName = _b.deviceName;
     ...
     */
    ScanSettings.prototype.getTextRecognitionSettings = function () {
     ...
     */
    ScanSettings.prototype.setTextRecognitionSettings = function (textRecognitionSettings) {
        this.textRecognitionSettings = textRecognitionSettings;
        return this;
    };
    /**
     ...
     */
    ScanSettings.prototype.getRecognitionMode = function () {
     ...
     * @returns The updated [[ScanSettings]] object.
     */
    ScanSettings.prototype.setRecognitionMode = function (recognitionMode) {
        this.recognitionMode = recognitionMode;
        if (recognitionMode.includes("text") && !__1.textRecognition) {
            logger_1.Logger.log(logger_1.Logger.Level.WARN, "The library has not been configured to load text recognition (ScanditSDK.configure() - loadTextRecognition option): ScanSettings' recognition mode for text will be ignored");
        }
        return this;
    };
    /**
    ...
    ScanSettings.prototype.setMultipleSymbologiesEnabled = function (symbology, enabled) {
        var e_1, _a, e_2, _b;
        try {
            for (var symbology_1 = (0, tslib_1.__values)(symbology), symbology_1_1 = symbology_1.next(); !symbology_1_1.done; symbology_1_1 = symbology_1.next()) {
        ...
        try {
            for (var symbology_2 = (0, tslib_1.__values)(symbology), symbology_2_1 = symbology_2.next(); !symbology_2_1.done; symbology_2_1 = symbology_2.next()) {
