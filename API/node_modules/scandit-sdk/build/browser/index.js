...
(function (global, factory) {
	  ...
	  return Object.create(
	    {
	      ...
	      withConverter: function (converter) {
	        return init(assign$2({}, this.converter, converter), this.attributes)
	      }
	    },
	    {
	...
	function dataCapture() {
	  ...
	  function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newHighEndBlurryRecognition, textRecognition, newLicenseKey, deviceModelName) {
	    ...
	    loadingInProgress = true; // Sample WebAssembly WAT SIMD Program, containing i8x16.popcnt as part of one of the latest SIMD opcodes
	    // (module
	    //   (func (result v128)
	    //     i32.const 1
	    //     i8x16.splat
	    ...
	    const simdSupport = WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 1, 253, 15, 253, 98, 11]));

	    const _getLibraryLocationUR = getLibraryLocationURIs(libraryLocation, textRecognition, simdSupport),
	    ...
	    Module = {
	      ...
	      instantiateWasm: function instantiateWasm(importObject, successCallback) {
	        ...
	        if (wasmJSVersion !== "5.9.0") {
	          log("error", "The Scandit Data Capture library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.9.0", "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
	        }
	  ...
	  function workOnScanQueue() {
	    ...
	    while (scanQueue.length !== 0) {
	      var _recognitionMode;

	      if (scanQueue[0].highQualitySingleFrameMode && // TODO: For now it's not possible to use imported variables as the worker doesn't have access at runtime
	      ((_recognitionMode = recognitionMode) === null || _recognitionMode === void 0 ? void 0 : _recognitionMode.includes("code")) === true && !blurryRecognitionAvailable) {
	        break;
	      }
	  ...
	  function getLibraryLocationURIs(libraryLocation, textRecognition, simdSupport) {
	    ...
	    if (/^https?:\/\/([^\/.]*\.)*cdn.jsdelivr.net\//.test(libraryLocation)) {
	      libraryLocation = "https://cdn.jsdelivr.net/npm/scandit-sdk@5.9.0/build/";
	      cdnURI = true;
	    } else if (/^https?:\/\/([^\/.]*\.)*unpkg.com\//.test(libraryLocation)) {
	      libraryLocation = "https://unpkg.com/scandit-sdk@5.9.0/build/";
	      cdnURI = true;
	    }
	    ...
	    return {
	      jsURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(fileExtension, ".min.js?v=5.9.0"),
	      wasmURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(fileExtension, ".wasm?v=5.9.0")
	    };
	  }
	  ...
	  function applyScanSettings() {
	    var _parsedSettings$textR, _recognitionMode2, _recognitionMode3, _parsedSettings$matri;
	    ...
	    (_parsedSettings$textR = parsedSettings.textRecognitionSettings) !== null && _parsedSettings$textR !== void 0 ? _parsedSettings$textR : parsedSettings.textRecognitionSettings = JSON.stringify({});
	    ...
	    const resultPointer = Module._scanner_settings_new_from_json(scanSettingsPointer, textRecognitionSettingsPointer, // TODO: For now it's not possible to use imported variables as the worker doesn't have access at runtime
	    ((_recognitionMode2 = recognitionMode) === null || _recognitionMode2 === void 0 ? void 0 : _recognitionMode2.includes("code")) === true, ((_recognitionMode3 = recognitionMode) === null || _recognitionMode3 === void 0 ? void 0 : _recognitionMode3.includes("text")) === true, parsedSettings.blurryRecognition === true && blurryRecognitionAvailable, (_parsedSettings$matri = parsedSettings.matrixScanEnabled) !== null && _parsedSettings$matri !== void 0 ? _parsedSettings$matri : false, highQualitySingleFrameMode, parsedSettings.gpuAcceleration === true && gpuAccelerationAvailable);
	  ...
	  function verifiedWasmFetch(wasmURI, textRecognition, simdSupport, awaitFullResponse) {
	      ...
	      if (typeof ((_crypto = crypto) === null || _crypto === void 0 ? void 0 : (_crypto$subtle = _crypto.subtle) === null || _crypto$subtle === void 0 ? void 0 : _crypto$subtle.digest) === "function") {
	        crypto.subtle.digest("SHA-256", responseData).then(function (hash) {
	          ...
	          if (hashString !== expectedHashString) {
	            log("error", "The Scandit Data Capture library WASM file found at ".concat(wasmURI, " seems invalid: ") + "expected file hash doesn't match (received: ".concat(hashString, ", ") + "expected: ".concat(expectedHashString, "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
	          }
	        }).catch(
	        /* istanbul ignore next */
	        function () {// Ignored
	        ...
	        log("warn", "Insecure context (see https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts): " + "The hash of the Scandit Data Capture library WASM file found at ".concat(wasmURI, " could not be verified"));
	      }
	    }
	    ...
	    return retryWithExponentialBackoff(tryFetch, 250, 4000, function (error) {
	      ...
	      log("error", error);
	      log("error", "Couldn't retrieve/instantiate Scandit Data Capture library at ".concat(wasmURI, ", ") + "did you configure the path for it correctly?");
	      return Promise.reject(error);
	    });
	  }
	  ...
	  function instantiateWebAssembly(importObject, wasmURI, textRecognition, simdSupport, successCallback) {
	    verifiedWasmFetch(wasmURI, textRecognition, simdSupport, true).then(function (response) {
	      ...
	      return self.WebAssembly.instantiate(bytes, importObject).then(function (results) {
	        ...
	        log("error", error);
	        log("error", "Couldn't instantiate Scandit Data Capture library at ".concat(wasmURI, ", ") + "did you configure the path for it correctly?");
	      });
	    }).catch(
	    /* istanbul ignore next */
	    function () {// Ignored
	  ...
	  function instantiateWebAssemblyStreaming(importObject, wasmURI, textRecognition, simdSupport, successCallback) {
	    verifiedWasmFetch(wasmURI, textRecognition, simdSupport, false).then(function (response) {
	  ...
	  _createClass(DataCaptureLoader, [{
	    ...
	    value: function load(dataCaptureWorker) {
	      ...
	      dataCaptureWorker.postMessage({
	        ...
	        textRecognition: exports.textRecognition,
	...
	(function (Logger) {
	  ...
	  var levelToNumber = new map([[Level.DEBUG, 1], [Level.INFO, 2], [Level.WARN, 3], [Level.ERROR, 4], [Level.QUIET, 5]]);
	  ...
	  function log(level) {
	    ...
	    switch (level) {
	      case Level.DEBUG:
	        (_console = console).debug.apply(_console, data);

	        break;

	      case Level.INFO:
	        (_console2 = console).log.apply(_console2, data);

	        break;

	      case Level.WARN:
	        (_console3 = console).warn.apply(_console3, data);

	        break;

	      case Level.ERROR:
	        (_console4 = console).error.apply(_console4, data);
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 8:
	                ...
	                // istanbul ignore next
	                exports.Logger.log(exports.Logger.Level.ERROR, _context.t0);
	        ...
	        switch (data[0]) {
	          ...
	          case "create-blurry-table-result":
	            ...
	            if (this.readyBlurryRecognitionSymbologies.size === BlurryRecognitionPreloader.availableBlurryRecognitionSymbologies.size) {
	              ...
	              setTimeout(function () {
	                _this2.dataCaptureWorker.terminate();
	              }, 250);
	            } else {
	              this.createNextBlurryTableSymbology();
	            }
	...
	})(exports.RecognizedText || (exports.RecognizedText = {}));
	...
	var ScanResult = /*#__PURE__*/function () {
	  ...
	  function ScanResult(barcodes, texts, imageData, imageSettings) {
	    ...
	    _defineProperty(this, "rejectedTexts", void 0);

	    this.barcodes = [];
	    barcodes.forEach(function (barcode) {
	      _this.barcodes.push(exports.Barcode.createFromWASMResult(barcode));
	    });
	    this.texts = [];
	    texts.forEach(function (text) {
	      _this.texts.push(exports.RecognizedText.createFromWASMResult(text));
	    });
	  ...
	  _createClass(ScanResult, [{
	    ...
	    key: "rejectText",
	    value: function rejectText(text) {
	...
	(function (SymbologySettings) {
	  ...
	  (function (Extension) {
	    ...
	    Extension["DEBUG_CONTROL_CHARACTERS"] = "debug_control_characters";
	    /**
	     * @hidden
	     */

	    Extension["GUESS_ENCODING"] = "guess_encoding";
	    /**
	     * @hidden
	     */

	    Extension["MIRRORED"] = "mirrored";
	    /**
	     * @hidden
	     */

	    Extension["NO_BLURRY_DECODING"] = "no_blurry_decoding";
	    /**
	     * @hidden
	     */

	    Extension["USE_UTF8_AS_DEFAULT_ENCODING"] = "use_utf8_as_default_encoding";
	 ...
	 * take effect.
	 */
	var TextRecognitionSettings = /*#__PURE__*/function () {
	  /**
	   * @hidden
	   *
	  ...
	  function TextRecognitionSettings() {
	    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        _ref$recognizer = _ref.recognizer,
	        recognizer = _ref$recognizer === void 0 ? "mrzFullScreen" : _ref$recognizer,
	        regex = _ref.regex,
	        characterWhitelist = _ref.characterWhitelist,
	        _ref$textDuplicateFil = _ref.textDuplicateFilter,
	        textDuplicateFilter = _ref$textDuplicateFil === void 0 ? 0 : _ref$textDuplicateFil;

	    _classCallCheck(this, TextRecognitionSettings);

	    _defineProperty(this, "properties", void 0);

	    _defineProperty(this, "recognizer", void 0);

	    _defineProperty(this, "regex", void 0);

	    _defineProperty(this, "characterWhitelist", void 0);

	    _defineProperty(this, "textDuplicateFilter", void 0);
	  ...
	  _createClass(TextRecognitionSettings, [{
	    key: "toJSONString",
	    ...
	    value: function getCharacterWhitelist() {
	    ...
	    value: function setCharacterWhitelist(characterWhitelist) {
	      this.characterWhitelist = characterWhitelist;
	      return this;
	    }
	    /**
	    ...
	    value: function getTextDuplicateFilter() {
	    ...
	    value: function setTextDuplicateFilter(durationMilliseconds) {
	...
	exports.ScanSettings = /*#__PURE__*/function () {
	  ...
	  function ScanSettings() {
	    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        _ref$textRecognitionS = _ref.textRecognitionSettings,
	        textRecognitionSettings = _ref$textRecognitionS === void 0 ? new TextRecognitionSettings() : _ref$textRecognitionS,
	        _ref$recognitionMode = _ref.recognitionMode,
	        recognitionMode = _ref$recognitionMode === void 0 ? ScanSettings.RecognitionMode.CODE : _ref$recognitionMode,
	    ...
	    _defineProperty(this, "textRecognitionSettings", void 0);

	    _defineProperty(this, "recognitionMode", void 0);
	  ...
	  _createClass(ScanSettings, [{
	    ...
	    value: function getTextRecognitionSettings() {
	    ...
	    value: function setTextRecognitionSettings(textRecognitionSettings) {
	      this.textRecognitionSettings = textRecognitionSettings;
	      return this;
	    }
	    /**
	    ...
	    value: function getRecognitionMode() {
	    ...
	    value: function setRecognitionMode(recognitionMode) {
	      this.recognitionMode = recognitionMode;

	      if (recognitionMode.includes("text") && !exports.textRecognition) {
	        exports.Logger.log(exports.Logger.Level.WARN, "The library has not been configured to load text recognition (ScanditSDK.configure() - loadTextRecognition option): ScanSettings' recognition mode for text will be ignored");
	      }
	...
	(function (ScanSettings) {
	  ...
	  })(ScanSettings.RecognitionMode || (ScanSettings.RecognitionMode = {}));
	...
	var Scanner = /*#__PURE__*/function () {
	  ...
	  _createClass(Scanner, [{
	              ...
	              case 17:
	                ...
	                return _context.abrupt("return", new promise(function (resolve, reject) {
	                  ...
	                  _this2.eventEmitter.once(workResultEvent, function (workResult, returnedImageData) {
	                    ...
	                    resolve(new ScanResult(workResult.barcodes, workResult.texts, returnedImageData, _this2.imageSettings));
	                  });

	                  _this2.eventEmitter.once(workErrorEvent, function (error, _) {
	                    exports.Logger.log(exports.Logger.Level.ERROR, "Scandit Data Capture error (".concat(error.errorCode, "):"), error.errorMessage);
	    ...
	    value: function dataCaptureWorkerOnMessage(ev) {
	      ...
	      if (data[0] === "log") {
	        exports.Logger.log.apply(exports.Logger, [data[1].level].concat(_toConsumableArray(data[1].data)));
	        return;
	      }
	...
	(function (CameraAccess) {
	  ...
	  function getMainCameraForType(cameras, cameraType) {
	    ...
	    if (exports.BrowserHelper.isDesktopDevice()) {
	      ...
	      if (allHaveBlankLabel) {
	        ...
	        // available.
	        var cameraOfTypeWithLabel = cameras.filter(function (camera) {
	          return camera.cameraType === cameraType && camera.label !== "";
	        });

	        if (cameraOfTypeWithLabel.length === 1) {
	          mainCameraForType = cameraOfTypeWithLabel[0];
	        } else if (cameraOfTypeWithLabel.length > 1) {
	          // Assume main front camera is the first one and main back camera is the last one.
	          mainCameraForType = cameraOfTypeWithLabel[cameraType === exports.Camera.Type.FRONT ? 0 : cameraOfTypeWithLabel.length - 1];
	        }
	      } else {
	        mainCameraForType = cameras.filter(function (camera) {
	          return camera.cameraType === cameraType;
	    ...
	    _getStreamForDeviceAccessPermission = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              if (!(availableVideoDevices != null && availableVideoDevices.length > 0 && availableVideoDevices.every(function (device) {
	                return device.label === "" && !CameraAccess.deviceIdToCameraObjects.has(device.deviceId);
	              }))) {
	                _context.next = 9;
	                break;
	  ...
	  function checkAndUpdateCameraDeviceIdInformation(oldAvailableDevices, newAvailableDevices) {
	    if (newAvailableDevices.length > 0 && oldAvailableDevices.length === newAvailableDevices.length && !newAvailableDevices.every(function (device, index) {
	      ...
	      exports.Logger.log(exports.Logger.Level.DEBUG, "Detected updated camera deviceId information and updated it accordingly", deviceIdChanges);
	    }
	  }
	  /**
	        ...
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              ...
	              cameraAlreadyAccessed = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
	            ...
	            case 22:
	              exports.Logger.log.apply(exports.Logger, [exports.Logger.Level.DEBUG, "Camera list (devices):"].concat(_toConsumableArray(availableVideoDevices)));
	            ...
	            case 33:
	              ...
	              exports.Logger.log.apply(exports.Logger, [exports.Logger.Level.DEBUG, "Camera list (cameras): "].concat(_toConsumableArray(cameras))); // Return a copy of the array to allow for array mutations in other functions
	  ...
	  function getUserMediaDelayed(getUserMediaParams) {
	    exports.Logger.log(exports.Logger.Level.DEBUG, "Attempt to access camera (parameters):", getUserMediaParams.video);
	    return new promise(function (resolve, reject) {
	      ...
	      return regenerator.wrap(function _callee3$(_context3) {
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              exports.Logger.log(exports.Logger.Level.DEBUG, "Attempt to access camera (camera):", camera);
	              getUserMediaParams = {
	                audio: false,
	            ...
	            case 11:
	              ...
	              if (!["OverconstrainedError", "NotReadableError", "NotAllowedError"].includes(_context3.t0.name)) {
	  ...
	  function markCameraAsInaccessible(camera) {
	    // If it's the initial camera, do nothing
	    if (camera.deviceId !== "") {
	      exports.Logger.log(exports.Logger.Level.DEBUG, "Camera marked to be inaccessible:", camera);
	...
	var CameraManager = /*#__PURE__*/function () {
	  function CameraManager(scanner, triggerCameraAccessError, gui) {
	    ...
	    _defineProperty(this, "triggerCameraAccessError", void 0);
	          ...
	          while (1) {
	            switch (_context4.prev = _context4.next) {
	              case 0:
	                ...
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Stop camera video stream access (stream):", this.mediaStream);
	          ...
	          while (1) {
	            switch (_context6.prev = _context6.next) {
	              case 0:
	                ...
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Camera reinitialization delayed");
	                _context6.next = 15;
	                break;

	              case 4:
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Reinitialize camera:", this.activeCamera);
	                _context6.prev = 5;
	                _context6.next = 8;
	              ...
	              case 10:
	                ...
	                exports.Logger.log(exports.Logger.Level.WARN, "Couldn't access camera:", this.activeCamera, _context6.t0);
	                this.triggerCameraAccessError(_context6.t0);
	                throw _context6.t0;
	        ...
	        return regenerator.wrap(function _callee12$(_context12) {
	          while (1) {
	            switch (_context12.prev = _context12.next) {
	              ...
	              case 6:
	                _context12.next = 8;
	                return exports.CameraAccess.getCameras(false, true);
	              ...
	              case 8:
	                ...
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Initial camera access was correct (main camera), keep camera:", activeCamera);
	              ...
	              case 25:
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Initial camera access was incorrect (not main camera), change camera", _objectSpread$1(_objectSpread$1({}, initialCamera), {}, {
	              ...
	              case 28:
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Initial camera access was incorrect (unknown camera), change camera", _objectSpread$1(_objectSpread$1({}, initialCamera), {}, {
	                  deviceId: initialCameraDeviceId
	                }));
	          ...
	          while (1) {
	            switch (_context13.prev = _context13.next) {
	              ...
	              case 9:
	                ...
	                exports.Logger.log(exports.Logger.Level.WARN, "Couldn't access camera:", autoselectedCamera, _context13.t0);
	                autoselectedCamera = cameras.shift();
	        ...
	        return regenerator.wrap(function _callee16$(_context16) {
	          while (1) {
	            switch (_context16.prev = _context16.next) {
	              case 0:
	                _context16.prev = 0;
	                exports.Logger.log(exports.Logger.Level.DEBUG, 'Detected video track "unmute" event, try to reinitialize camera');
	                _context16.next = 4;
	                return this.reinitializeCamera();
	        ...
	        return regenerator.wrap(function _callee26$(_context26) {
	          while (1) {
	            switch (_context26.prev = _context26.next) {
	              case 0:
	                if (!(!["OverconstrainedError", "NotReadableError"].includes(error.name) || error.name === "NotReadableError" && cameraResolutionConstraint === CameraResolutionConstraint.NONE)) {
	                  _context26.next = 4;
	                  break;
	                }

	                // Camera is not accessible at all
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Camera video stream access failure (unrecoverable error)", camera, error);
	              ...
	              case 4:
	                ...
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Camera video stream access failure (no camera with such type error)", camera, error);
	                throw error;

	              case 8:
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Detected non-existent deviceId error, attempt to find and reaccess updated camera", camera, error);
	              ...
	              case 12:
	                ...
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Camera video stream access failure (updated camera not found after non-existent deviceId error)", camera, error);
	                exports.CameraAccess.markCameraAsInaccessible(camera);
	                throw error;

	              case 18:
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Updated camera found (recovered from non-existent deviceId error), attempt to access it", camera);
	          ...
	          while (1) {
	            switch (_context27.prev = _context27.next) {
	              ...
	              case 10:
	                ...
	                exports.Logger.log(exports.Logger.Level.DEBUG, "Camera video stream access failure (invalid video metadata):", camera);
	                    ...
	                    return regenerator.wrap(function _callee28$(_context28) {
	                      while (1) {
	                        switch (_context28.prev = _context28.next) {
	                          case 0:
	                            exports.Logger.log(exports.Logger.Level.DEBUG, "Camera video stream access failure (video data load timeout):", camera);
	                            _context28.next = 3;
	                ...
	                return _context31.abrupt("return", new promise(function (resolve, reject) {
	                  _this10.gui.videoElement.onloadeddata = function () {
	                    ...
	                    if (_this10.gui.videoElement.videoWidth > 2 && _this10.gui.videoElement.videoHeight > 2 && _this10.gui.videoElement.currentTime > 0) {
	                      ...
	                      exports.Logger.log(exports.Logger.Level.DEBUG, "Camera video stream access success:", camera);
	                      return resolve();
	                    }
	                        ...
	                        while (1) {
	                          switch (_context30.prev = _context30.next) {
	                            case 0:
	                              ...
	                              exports.Logger.log(exports.Logger.Level.DEBUG, "Camera video stream access failure (valid video metadata timeout):", camera);
	                              window.clearInterval(_this10.videoMetadataCheckInterval);
	                              _context30.next = 6;
	...
	var GUI = /*#__PURE__*/function () {
	  ...
	  function GUI(options) {
	    ...
	    _defineProperty(this, "isVideoElementDetached", false);
	  ...
	  _createClass(GUI, [{
	    ...
	    value: function getImageData(imageData) {
	      ...
	      if (!this.singleImageModeEnabled) {
	        if (this.contextWebGL != null) {
	          ...
	          if (imageData[3] !== 255) {
	            exports.Logger.log(exports.Logger.Level.WARN, "Detected incorrect GPU accelerated WebGL image processing, switching to canvas mode");
	    ...
	    key: "setVideoVisible",
	    value: function setVideoVisible(visible) {
	    ...
	    value: function setupContext(canvas) {
	      ...
	      if (context != null) {
	        ...
	        canvas.addEventListener("webglcontextlost", function () {
	          ...
	          exports.Logger.log(exports.Logger.Level.WARN, "WebGL context has been lost, restoring...");
	          ...
	          exports.Logger.log(exports.Logger.Level.WARN, "WebGL context restored");
	        });
	      } else {
	        this.context2d = canvas.getContext("2d");
	      }
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                _context.prev = 2;
	                exports.Logger.log(exports.Logger.Level.DEBUG, 'Detected visibility change ("visible") event with inactive video source, try to reinitialize camera');
	                _context.next = 6;
	              ...
	              case 12:
	                exports.Logger.log(exports.Logger.Level.DEBUG, 'Detected visibility change ("visible") event with active video source, replay video');
	                this.playVideo();
	    ...
	    value: function cameraUploadFile() {
	      ...
	      if (files != null && files.length !== 0) {
	        ...
	        fileReader.onload = function () {
	          ...
	          if (fileReader.result != null) {
	            ...
	            image.onerror = function () {
	              ...
	              exports.Logger.log(exports.Logger.Level.WARN, "Could not load image from selected file");
	            };
	        ...
	        fileReader.onerror = function () {
	          var _fileReader$error;

	          _this4.cameraUploadInProgress = false;
	          exports.Logger.log(exports.Logger.Level.WARN, "Error while reading the file: ".concat((_fileReader$error = fileReader.error) === null || _fileReader$error === void 0 ? void 0 : _fileReader$error.toString()));
	        };
	          ...
	          while (1) {
	            switch (_context4.prev = _context4.next) {
	              ...
	              case 21:
	                ...
	                exports.Logger.log(exports.Logger.Level.WARN, "Couldn't access camera:", cameras[newCameraIndex], _context4.t0);
	              ...
	              case 36:
	                ...
	                exports.Logger.log(exports.Logger.Level.ERROR, _context4.t1);
	                this.cameraSwitchInProgress = false;
	...
	exports.BarcodePicker = /*#__PURE__*/function () {
	  ...
	  _createClass(BarcodePicker, [{
	    ...
	    value: function triggerCameraAccessError(error) {
	    ...
	    value: function handleScanResult(scanResult) {
	      ...
	      if (scanResult.barcodes.length !== 0 || scanResult.texts.length !== 0) {
	        ...
	        this.eventEmitter.once("scan", function () {
	          var acceptedBarcodes = scanResult.barcodes.some(function (barcode) {
	            return !scanResult.rejectedCodes.has(barcode);
	          });
	          var acceptedTexts = scanResult.texts.some(function (text) {
	        ...
	        return regenerator.wrap(function _callee11$(_context11) {
	          while (1) {
	            switch (_context11.prev = _context11.next) {
	              ...
	              case 2:
	                if (!(((_this$getActiveCamera = this.getActiveCamera()) === null || _this$getActiveCamera === void 0 ? void 0 : _this$getActiveCamera.currentResolution) == null || this.scanningPaused || !this.scanner.isReady() || this.scanner.isBusyProcessing() || this.latestVideoTimeProcessed === this.gui.getVideoCurrentTime())) {
	                  _context11.next = 5;
	                  break;
	                }
	    ...
	    key: "submitFrame",
	    value: function submitFrame(scanResult) {// Ignored
	    }
	    /**
	    ...
	    key: "processFrame",
	    value: function processFrame(scanResult) {// Ignored
	    }
	    /**
	    ...
	    key: "scan",
	    value: function scan(scanResult) {// Ignored
	    }
	    /**
	    ...
	    key: "scanError",
	    value: function scanError(error) {// Ignored
	    }
	    /**
	    ...
	    key: "cameraAccessError",
	    value: function cameraAccessError(error) {// Ignored
	    }
	    /**
	            ...
	            switch (_context12.prev = _context12.next) {
	              ...
	              case 9:
	                if (!browserCompatibility.fullSupport && !singleImageModeForced) {
	                  exports.Logger.log(exports.Logger.Level.INFO, "BarcodePicker's Single Image Mode is being used as fallback as the OS/browser combination doesn't " + "support camera video stream scanning (https://caniuse.com/#feat=stream). " + 'You can configure this behaviour via the "singleImageModeSettings" option.', browserCompatibility);
	                }
	...
	function getSchema() {
	  ...
	  return schema = Object.freeze({
	    ...
	    [Attribute.SCAN_SETTINGS_RECOGNITION_MODE]: {
	      ...
	      default: exports.ScanSettings.RecognitionMode.CODE
	    },
	...
	_Attribute$CONFIGURE_3 = Attribute.CONFIGURE_HIGH_QUALITY_BLURRY_RECOGNITION;
	_Attribute$CONFIGURE_4 = Attribute.CONFIGURE_LOAD_TEXT_RECOGNITION;
	_Attribute$CONFIGURE_5 = Attribute.CONFIGURE_PRELOAD_BLURRY_RECOGNITION;
	_Attribute$CONFIGURE_6 = Attribute.CONFIGURE_PRELOAD_ENGINE;
	...
	_Attribute$SCAN_SETTI8 = Attribute.SCAN_SETTINGS_RECOGNITION_MODE;
	_Attribute$SCAN_SETTI9 = Attribute.SCAN_SETTINGS_SEARCH_AREA;
	_Attribute$SCAN_SETTI10 = Attribute.SCAN_SETTINGS_TEXT_RECOGNITION_SETTINGS;
	var LazyAttributeConverter = /*#__PURE__*/function (_Attribute$ACCESS_CAM2, _Attribute$CAMERA2, _Attribute$CAMERA_SET2, _Attribute$CAMERA_TYP2, _Attribute$CONFIGURE2, _Attribute$ENABLE_CAM2, _Attribute$ENABLE_PIN2, _Attribute$ENABLE_TAP2, _Attribute$ENABLE_TOR2, _Attribute$GUI_STYLE2, _Attribute$LASER_AREA2, _Attribute$PLAY_SOUND2, _Attribute$SCANNING_P2, _Attribute$SINGLE_IMA2, _Attribute$TARGET_SCA2, _Attribute$VIBRATE_ON2, _Attribute$VIDEO_FIT2, _Attribute$VIEWFINDER2, _Attribute$VISIBLE2, _Attribute$CONFIGURE_7, _Attribute$CONFIGURE_8, _Attribute$CONFIGURE_9, _Attribute$CONFIGURE_10, _Attribute$CONFIGURE_11, _Attribute$CONFIGURE_12, _Attribute$SCAN_SETTI11, _Attribute$SCAN_SETTI12, _Attribute$SCAN_SETTI13, _Attribute$SCAN_SETTI14, _Attribute$SCAN_SETTI15, _Attribute$SCAN_SETTI16, _Attribute$SCAN_SETTI17, _Attribute$SCAN_SETTI18, _Attribute$SCAN_SETTI19, _Attribute$SCAN_SETTI20) {
	...
	}(_Attribute$ACCESS_CAM, _Attribute$CAMERA, _Attribute$CAMERA_SET, _Attribute$CAMERA_TYP, _Attribute$CONFIGURE, _Attribute$ENABLE_CAM, _Attribute$ENABLE_PIN, _Attribute$ENABLE_TAP, _Attribute$ENABLE_TOR, _Attribute$GUI_STYLE, _Attribute$LASER_AREA, _Attribute$PLAY_SOUND, _Attribute$SCANNING_P, _Attribute$SINGLE_IMA, _Attribute$TARGET_SCA, _Attribute$VIBRATE_ON, _Attribute$VIDEO_FIT, _Attribute$VIEWFINDER, _Attribute$VISIBLE, _Attribute$CONFIGURE_, _Attribute$CONFIGURE_2, _Attribute$CONFIGURE_3, _Attribute$CONFIGURE_4, _Attribute$CONFIGURE_5, _Attribute$CONFIGURE_6, _Attribute$SCAN_SETTI, _Attribute$SCAN_SETTI2, _Attribute$SCAN_SETTI3, _Attribute$SCAN_SETTI4, _Attribute$SCAN_SETTI5, _Attribute$SCAN_SETTI6, _Attribute$SCAN_SETTI7, _Attribute$SCAN_SETTI8, _Attribute$SCAN_SETTI9, _Attribute$SCAN_SETTI10);
	...
	***************************************************************************** */
	...
	var Validator = /*#__PURE__*/function () {
	  ...
	  _createClass(Validator, null, [{
	    ...
	    value: function isValidRecognitionMode(value) {
	      return values(exports.ScanSettings.RecognitionMode).includes(value);
	    }
	  }, {
	    key: "isArray",
	    ...
	    value: function isValidTextRecognitionSettingsObject(value) {
	      var settings;
	...
	__decorate([validationMessage("recognitionMode")], Validator, "isValidRecognitionMode", null);
	...
	__decorate([validationMessage("textRecognitionSettings")], Validator, "isValidTextRecognitionSettingsObject", null);
	  ...
	  _createClass(Controller, [{
	      ...
	      switch (attribute) {
	        case Attribute.ACCESS_CAMERA:
	          if (this.lazyAttributeConverter[Attribute.ACCESS_CAMERA]) {
	            this.picker.accessCamera().catch(function (reason) {
	              exports.Logger.log(exports.Logger.Level.WARN, "Error while accessing the camera:", reason);
	            });
	          } else {
	        ...
	        case Attribute.SCANNING_PAUSED:
	          ...
	          this.picker.resumeScanning().catch(function (reason) {
	            exports.Logger.log(exports.Logger.Level.WARN, "Error while resuming scanning:", reason);
	          });
	          break;
	        ...
	        case Attribute.CAMERA:
	          this.getCameraFromAttribute().then(function (camera) {
	            _this.picker.setActiveCamera(camera).catch(function (reason) {
	              exports.Logger.log(exports.Logger.Level.WARN, "Error while setting the active camera:", reason);
	            });
	          }).catch(function (reason) {
	            exports.Logger.log(exports.Logger.Level.WARN, "Error while getting the camera:", reason);
	          });
	          break;
	        ...
	        case Attribute.CAMERA_TYPE:
	          this.picker.setCameraType(this.lazyAttributeConverter[Attribute.CAMERA_TYPE]).catch(function (reason) {
	            exports.Logger.log(exports.Logger.Level.WARN, "Error while setting camera type:", reason);
	          });
	          break;
	        ...
	        case Attribute.CAMERA_SETTINGS:
	          this.picker.applyCameraSettings(this.lazyAttributeConverter[Attribute.CAMERA_SETTINGS]).catch(function (reason) {
	            exports.Logger.log(exports.Logger.Level.WARN, "Error while applying camera settings:", reason);
	          });
	          break;
	        //
	        ...
	        case Attribute.SCAN_SETTINGS_TEXT_RECOGNITION_SETTINGS:
	          this.scanSettings.setTextRecognitionSettings(this.lazyAttributeConverter[Attribute.SCAN_SETTINGS_TEXT_RECOGNITION_SETTINGS]);
	          this.picker.applyScanSettings(this.scanSettings);
	          break;
	        ...
	        case Attribute.CONFIGURE:
	          if (this.lazyAttributeConverter[Attribute.CONFIGURE]) {
	            this.initPicker().catch(function (reason) {
	              exports.Logger.log(exports.Logger.Level.WARN, "Error while initializing barcode picker:", reason);
	            });
	          }
	          ...
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              ...
	              case 4:
	                ...
	                if (userCamera == null) {
	                  exports.Logger.log(exports.Logger.Level.WARN, "Could not find camera with id \"".concat(userCameraId, "\", will use default camera."));
	                }
	    ...
	    value: function validateAttribute(name, value) {
	      ...
	      if (!validatorFunction(value)) {
	        ...
	        exports.Logger.log(exports.Logger.Level.WARN, "Invalid value for attribute \"".concat(normalizedAttribute, "\": \"").concat(value, "\". ").concat((_Validator$expectatio = Validator.expectationMessage.get(validatorFunction)) !== null && _Validator$expectatio !== void 0 ? _Validator$expectatio : ""));
	        return false;
	      }
	    ...
	    value: function handleException(e) {
	      exports.Logger.log(exports.Logger.Level.ERROR, e);
	    }
	  }]);
	...
	exports.textRecognition = void 0;
	/**
	 * @hidden
	 */
	...
	function configure(licenseKey) {
	  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
	      ...
	      logLevel = _ref$logLevel === void 0 ? exports.Logger.Level.DEBUG : _ref$logLevel,
	      ...
	      _ref$loadTextRecognit = _ref.loadTextRecognition,
	      loadTextRecognition = _ref$loadTextRecognit === void 0 ? false : _ref$loadTextRecognit,
	    ...
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
	      ...
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              exports.Logger.log(exports.Logger.Level.INFO, "Scandit Web SDK version: 5.9.0");
	            ...
	            case 7:
	              ...
	              return new promise(function (resolveCheck) {
	                function checkIndexedDBStatus() {
	                  indexedDB.databases().then(resolveCheck).catch(
	                  /* istanbul ignore next */
	                  function () {// Ignored
	                  });
	                }
