          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                // istanbul ignore next
                Logger.log(Logger.Level.ERROR, _context.t0);
...
var ScanResult = /*#__PURE__*/function () {
  ...
  function ScanResult(barcodes, texts, imageData, imageSettings) {
    ...
    barcodes.forEach(function (barcode) {
      _this.barcodes.push(Barcode.createFromWASMResult(barcode));
    });
    this.texts = [];
    texts.forEach(function (text) {
      _this.texts.push(RecognizedText.createFromWASMResult(text));
    });
...
var Scanner = /*#__PURE__*/function () {
  ...
  _createClass(Scanner, [{
              ...
              case 17:
                ...
                return _context.abrupt("return", new promise(function (resolve, reject) {
                  ...
                  _this2.eventEmitter.once(workErrorEvent, function (error, _) {
                    Logger.log(Logger.Level.ERROR, "Scandit Data Capture error (".concat(error.errorCode, "):"), error.errorMessage);
    ...
    value: function dataCaptureWorkerOnMessage(ev) {
      ...
      if (data[0] === "log") {
        Logger.log.apply(Logger, [data[1].level].concat(_toConsumableArray(data[1].data)));
        return;
      }
    ...
    if (BrowserHelper.isDesktopDevice()) {
      ...
      if (allHaveBlankLabel) {
        ...
        if (cameraOfTypeWithLabel.length === 1) {
          ...
          mainCameraForType = cameraOfTypeWithLabel[cameraType === Camera.Type.FRONT ? 0 : cameraOfTypeWithLabel.length - 1];
        }
      } else {
        mainCameraForType = cameras.filter(function (camera) {
          return camera.cameraType === cameraType;
      ...
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 22:
              Logger.log.apply(Logger, [Logger.Level.DEBUG, "Camera list (devices):"].concat(_toConsumableArray(availableVideoDevices)));
            ...
            case 33:
              ...
              Logger.log.apply(Logger, [Logger.Level.DEBUG, "Camera list (cameras): "].concat(_toConsumableArray(cameras))); // Return a copy of the array to allow for array mutations in other functions
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                Logger.log(Logger.Level.DEBUG, "Stop camera video stream access (stream):", this.mediaStream);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 10:
                ...
                Logger.log(Logger.Level.WARN, "Couldn't access camera:", this.activeCamera, _context6.t0);
        ...
        return regenerator.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 6:
                _context12.next = 8;
                return CameraAccess.getCameras(false, true);
              ...
              case 25:
                Logger.log(Logger.Level.DEBUG, "Initial camera access was incorrect (not main camera), change camera", _objectSpread$1(_objectSpread$1({}, initialCamera), {}, {
              ...
              case 28:
                Logger.log(Logger.Level.DEBUG, "Initial camera access was incorrect (unknown camera), change camera", _objectSpread$1(_objectSpread$1({}, initialCamera), {}, {
                  deviceId: initialCameraDeviceId
                }));
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 9:
                ...
                Logger.log(Logger.Level.WARN, "Couldn't access camera:", autoselectedCamera, _context13.t0);
                autoselectedCamera = cameras.shift();
        ...
        return regenerator.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                _context16.prev = 0;
                Logger.log(Logger.Level.DEBUG, 'Detected video track "unmute" event, try to reinitialize camera');
                _context16.next = 4;
                return this.reinitializeCamera();
    ...
    value: function getImageData(imageData) {
      ...
      if (!this.singleImageModeEnabled) {
        if (this.contextWebGL != null) {
          ...
          if (imageData[3] !== 255) {
            Logger.log(Logger.Level.WARN, "Detected incorrect GPU accelerated WebGL image processing, switching to canvas mode");
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                Logger.log(Logger.Level.DEBUG, 'Detected visibility change ("visible") event with inactive video source, try to reinitialize camera');
                _context.next = 6;
              ...
              case 12:
                Logger.log(Logger.Level.DEBUG, 'Detected visibility change ("visible") event with active video source, replay video');
                this.playVideo();
    ...
    value: function cameraUploadFile() {
      ...
      if (files != null && files.length !== 0) {
        ...
        fileReader.onerror = function () {
          ...
          _this4.cameraUploadInProgress = false;
          Logger.log(Logger.Level.WARN, "Error while reading the file: ".concat((_fileReader$error = fileReader.error) === null || _fileReader$error === void 0 ? void 0 : _fileReader$error.toString()));
        };
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 21:
                ...
                Logger.log(Logger.Level.WARN, "Couldn't access camera:", cameras[newCameraIndex], _context4.t0);
              ...
              case 36:
                ...
                Logger.log(Logger.Level.ERROR, _context4.t1);
                this.cameraSwitchInProgress = false;
            ...
            switch (_context12.prev = _context12.next) {
              ...
              case 9:
                if (!browserCompatibility.fullSupport && !singleImageModeForced) {
                  Logger.log(Logger.Level.INFO, "BarcodePicker's Single Image Mode is being used as fallback as the OS/browser combination doesn't " + "support camera video stream scanning (https://caniuse.com/#feat=stream). " + 'You can configure this behaviour via the "singleImageModeSettings" option.', browserCompatibility);
                }
...
var Validator = /*#__PURE__*/function () {
  ...
  _createClass(Validator, null, [{
    ...
    value: function isValidRecognitionMode(value) {
      return values(ScanSettings.RecognitionMode).includes(value);
    }
  }, {
    key: "isArray",
  ...
  _createClass(Controller, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                if (userCamera == null) {
                  Logger.log(Logger.Level.WARN, "Could not find camera with id \"".concat(userCameraId, "\", will use default camera."));
                }
    ...
    value: function validateAttribute(name, value) {
      ...
      if (!validatorFunction(value)) {
        ...
        Logger.log(Logger.Level.WARN, "Invalid value for attribute \"".concat(normalizedAttribute, "\": \"").concat(value, "\". ").concat((_Validator$expectatio = Validator.expectationMessage.get(validatorFunction)) !== null && _Validator$expectatio !== void 0 ? _Validator$expectatio : ""));
        return false;
      }
...
function configure(licenseKey) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      logLevel = _ref$logLevel === void 0 ? Logger.Level.DEBUG : _ref$logLevel,
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              Logger.log(Logger.Level.INFO, "Scandit Web SDK version: 5.9.0");
